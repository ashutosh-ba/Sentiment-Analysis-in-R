...
# temp.text = readLines('D:\\current work\\NLP related\\Session 2\\mission vision.csv')
...
url = "http://www.imdb.com/title/tt0111161/reviews?filter=love;filter=love;start=0"
